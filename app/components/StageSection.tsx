  ...
  const stageDetails = {
    ...
    missions: [
      ...
      },
      {
        ...
        description: "Mise à jour des contrats, documentation et archivage des documents internes",
        details:
          "J'ai contribué à la mise à jour des contrats d'abonnement, à la relecture et à l'adaptation de la documentation liée à la clientèle, ainsi qu'à l'organisation et à l'archivage des documents internes du service.",
        icon: FileText,
    ...
    <div className="min-h-screen px-8 pb-20">
      ...
      <div className="relative z-20 max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          {activeSection === "overview" && (
            <div className="space-y-8 animate-on-scroll">
              <Card className="border border-cyan-500/30 shadow-2xl bg-black/20 backdrop-blur-xl">
          ...
          {activeSection === "missions" && (
            <div className="space-y-8 animate-on-scroll">
              {stageDetails.missions.map((mission, index) => (
                <Card key={index} className="border border-cyan-500/30 shadow-2xl bg-black/20 backdrop-blur-xl">
        ...
        <div className="text-center mt-16">
          <Button
            onClick={onNavigateHome}
            className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white shadow-xl hover:shadow-2xl transition-all duration-300 px-8 py-4 text-lg font-semibold rounded-xl"
          >
